...
T_{air} - T_{b} & |~T>0~~\\ 
0 & |~T<30
\end{array}\right.$$ {#eq-effective-temperature}
...
$$Q = 0.5 \cdot R_{global} \cdot 1 - e^{-k_{PAR} \cdot LAI}$$ {#eq-monteith}
...
$$\frac{dDM_{total}} {dt} = Q \cdot LUE_{par} \cdot f_{droughtLUE} \cdot f_{tempLUE}$$ {#eq-dm-change}
...
$$LAI_{susmax} = \frac{1} {k} \cdot log(\frac{PAR_{mean}} {PAR_x \cdot f_{tempLAI}})$$ {#eq-LAI-susmax}
...
\end{array} \right.$$ {#eq-LAI-senescence}
